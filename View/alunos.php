                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form">
                                        ...
                                        <button type="reset" class="btn btn-danger">Cancelar Cadastro</button>
                                        <div>
                                    </form>
                                </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td>1</td>
                                        <td>Godofredo Rodrigues da Programação</td>
                                        <td>11 5555-5555</td>
                                        <td class="center"><button class="btn btn-primary btn-xs"><i id="btn-detalhe" class="fa  fa-eye"></i> </button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
