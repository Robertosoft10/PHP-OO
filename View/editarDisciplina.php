...
if(isset($_GET['disciId'])){
    $disciId = $_GET['disciId'];
    $disciplina = $disciplinaDAO->searchDisciplina($disciId);
  }
 ?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <div id="wrapper">
        ...
        <nav  id="barra-pagina" class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="l"  id="barra-pagina">Sistema Escolar 2.0</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                <form role="form" action="../Controller/atualizarDisciplina.php?disciId=<?= $disciplina->getDisciId();?>" method="post">
